...
import DatePickerCart from "./datepicker";
import GoogleMaps from "../Poster-Details/googleMap";
...
const CartPosterDetails: React.FC<PosterDetailsProps> = ({ id }) => {
...
export default CartPosterDetails;
